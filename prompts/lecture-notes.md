# Parse lecture note images

```md
Convert lecture notes to plaintext

1. Convert any headings to markdown leveled headings, start at level 1
2. no numbered headings
3. use "-" for bullets
4. no page numbers or dividers
5. no bold text
6. no latex
```
